...
public class BaseTest {
	...
	public WebDriver intializeBrowser() throws Throwable {

		Properties prop = new Properties();

		FileInputStream fis = new FileInputStream(
				System.getProperty("user.dir") + "\\src\\main\\java\\com\\resources\\GlobalData.properties");// no need
																												// to
																												// add
																												// full
																												// path
	...
	public List<HashMap<String, String>> getJsonDataToMap(String filepath) throws Throwable {
	...
	public String getScreenshot(String testcasename, WebDriver driver) throws Throwable {
		...
		FileUtils.copyFile(sources, filepath);
